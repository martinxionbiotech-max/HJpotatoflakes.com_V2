...
| Storage Parameter | Fresh Storage (<4 weeks) | Long-Term Storage (4-40 weeks) |
|:-----------------|:-----------------------:|:------------------------------:|
| Temperature Range | 12-15°C | 4-8°C (reconditioned before processing) |
| Relative Humidity | 90-95% | 85-90% |
| CO₂ Concentration | <3000 ppm | <3000 ppm |
| Ventilation Rate | 0.1-0.2 m³/h per tonne | 0.05-0.1 m³/h per tonne |
| Sprout Inhibition | Not required | CIPC (chlorpropham) or alternative |

## Documents

| # | Document | Description |
|:-:|:---------|:------------|
| 1 | [Potato Storage Technology Guide](potato-storage-technology-guide.md) | Storage physiology, facility types, temperature/humidity control, sprout inhibition, disease management |
