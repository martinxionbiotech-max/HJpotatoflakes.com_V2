---
description: "How HONGJI technical documents are prepared, reviewed, numbered, versioned and released — and how buyers can obtain controlled copies of specifications, datasheets and COAs."
---

# Document Control & Technical Team

**Entity:** Zhangjiakou Hongji Agriculture Technology Development Co., Ltd. (张家口弘基农业科技开发有限责任公司)
**Responsible department:** Quality Control Department
**Document families:** `HJ-TD` (technical documentation), `HJ-TD-PE` (production entity archive), `HJ-QA` (analytical methods), `HJ-QC-FC` / `HJ-SOP-FC` (QC forms and SOPs)
...
Requests go through the contact route on the main website — see [Request a Quote / Contact](https://hjpotatoflakes.com/contact-us/) — or by email to `sales@hjpotatoflakes.com`. State the product grade, the parameters you need verified and the method your own specification cites, so the correct controlled document is issued.
...
See also [Technical Data Governance](../technical-data-governance.md) for how values must be labelled when quoted (typical vs guaranteed, method, and version).
...
- [Product Specification](../domain-09-production-entity/potato-flakes-product-specification.md)
- [Quality & Food Safety Management Manual](../domain-09-production-entity/quality-food-safety-management-manual.md)
- [Quality Assurance System Overview](../domain-05-quality-control/quality-assurance-system-overview.md)
- [Batch Traceability System](../domain-05-quality-control/batch-traceability-system.md)
- [Technical Data Governance](../technical-data-governance.md)
- [Production Entity Archive](index.md)
