...
| **Bulk Density (Loose/Tapped)** | HJ-QA-010-SOP-02 / SOP-03 (see Physical Specifications for the equivalent ASTM / ISO / GB methods) | Influences packaging density, transport cost, and volumetric dosing. Low loose BD = high air entrapment = more packaging volume per kg | Significant deviation from historical average may indicate altered process conditions |
